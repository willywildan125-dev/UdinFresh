...
export default function SupirDashboardPage() {
  ...
  const handleSelesaikan = async (id_pesanan) => {
    if (!window.confirm('Apakah Anda yakin pesanan ini sudah sampai ke tangan konsumen?')) return;
    ...
    try {
      ...
      if (data.success) {
        ...
        fetchOrders(supir.id_supir); // Refresh data
      } else {
                ...
                <div key={order.id_pesanan} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative">
                  ...
                  <div className="p-4 pl-5">
                    ...
                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 mb-4">
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Daftar Barang ({order.total_berat} kg)</p>
