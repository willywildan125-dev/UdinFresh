...
export default function ProductCardHorizontal({ produk }) {
  ...
  return (
    <Link to={`/product/${produk.id_produk || 1}`} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-2 md:p-3 flex items-center gap-3 md:gap-4 hover:shadow-md transition-shadow group block">
      ...
      <button 
        ...
        className="w-8 h-8 rounded-full border border-gray-200 text-emerald-600 flex items-center justify-center hover:bg-emerald-50 transition-colors shrink-0 mr-1"
      >
